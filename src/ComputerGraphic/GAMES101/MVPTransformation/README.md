...
左上角的 $3 \times 3$ 矩陣是個對角矩陣，把寬度變成 width，並把高度變成 height，但此時中心還在原點 $(0, 0)$，但螢幕空間的左下角才是原點，因此要把中心移到螢幕空間對應的中心上，而這個位移稍微想一下我們很快就可以得到要移動 $\frac{width}{2}$ 與 $\frac{height}{2}$
