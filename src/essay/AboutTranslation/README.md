...
由於是在講多層頁表，所以這整段當中的主詞有「第一層頁表」、「第二層頁表」、「第三層頁表」。 然而在 GPT 的翻譯中，它並沒有強調原文中提到的三個 PTE 個屬於哪個頁表，因此我刻意地加上了主詞，將其翻為：
...
如同上面說的，這個真的很見仁見智，如果你背景知識足夠，那 GPT 的翻譯時肯定能很快的知道各 PTE 屬於哪個頁表，甚至可能會覺得我翻的版本有些冗長。 但這只是我的解法，還有我意識到的問題，有許你有更好的翻譯版本也說不定
